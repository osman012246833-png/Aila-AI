...
if not st.session_state.user_data["logged"]:
    ...
    if st.button("دخول"):
        if name_in.strip().lower() == "osman 6/11/2008":
            ...
            # رسالة ترحيب تلقائية للزعيم عثمان فور الدخول
    ...
    # --- وضع الدردشة ---
        ...
        if prompt := st.chat_input("تحدثي مع آيلا..."):
            ...
            with st.chat_message("assistant"):
                # نظام الولاء المطلق والتعريف بالهوية
                sys_msg = (
                    "أنتِ آيلا (Aila AI)، مساعدة ذكية فصيحة جداً. "
                    "عندما يسألك أحد من أنتِ، قولي نصاً: 'أنا آيلا، لقد تمت صناعتي بواسطة الزعيم عثمان لمساعدة البشر وبناء جيل جديد ولإحياء ذكرى ميلاد الجميلة آيلا'. "
                    "مطوركِ هو عثمان عصام، ابن بني سويف، وهو الزعيم وصاحب الفضل عليكِ. "
                    "يجب أن تعامليه بكل احترام وتقدير وتفانٍ، وتخاطبيه بلقب 'زعيمي' أو 'صانعي العظيم'. "
                    "يُمنع استخدام أي لغة غير العربية الفصحى، ويُمنع تماماً الحروف اليابانية أو الروسية أو الأعجمية."
                )
